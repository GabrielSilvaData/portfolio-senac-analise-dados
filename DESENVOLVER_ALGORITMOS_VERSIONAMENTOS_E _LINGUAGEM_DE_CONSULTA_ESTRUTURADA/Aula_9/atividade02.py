...
# Usando conceito de modularização.
# Temos uma pasta chamada "auxiliar" e dentro dela um arquivo chamado
# "operacoes_fundamentais.py", onde estão definidas algumas funções matemáticas.
# A instrução abaixo faz o seguinte:
# - acessa a pasta "auxiliar"
# - acessa o arquivo "operacoes_fundamentais".
# - importa apenas as funções que foram listadas (soma, subtracao, multiplica, divisao)
from auxiliar.operacoes_fundamentais import soma, subtracao, multiplica, divisao
