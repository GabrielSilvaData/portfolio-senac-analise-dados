...
try:
    ...
    # Interpretação:
    # Quanto maior a variancia, maior é o afastamento dos valores em relação a média.
    ...
    # É a normalização da Variância. Por isso é mais fácil a interpretação
...
try:
    ...
    contagens, limites = np.histogram(array_roubo_veiculo, bins=10)
