...
SELECT 
	...
	tb_livros.titulo, tb_livros.id_livro, 
    tb_itens_alugados.id_aluguel, tb_alugados.data_aluguel, tb_alugados.data_devolucao,
    tb_alugados.valor    
FROM tb_livros
JOIN tb_itens_alugados ON tb_itens_alugados.id_livro = tb_livros.id_livro
JOIN tb_alugados ON tb_alugados.id_aluguel = tb_itens_alugados.id_aluguel
JOIN tb_usuarios ON tb_usuarios.id_usuario = tb_alugados.id_usuario
