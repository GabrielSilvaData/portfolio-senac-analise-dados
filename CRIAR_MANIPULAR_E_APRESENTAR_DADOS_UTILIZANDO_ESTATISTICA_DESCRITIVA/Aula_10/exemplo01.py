...
# Polars é uma bibioteca que trabalha com Multithread. Por isso, recomenda-se p/ trabalhos
# em larga escala. A tendência é que seja bem mais rápido que o pandas, 
# pois o processamento de dados é feito em paralelo.
# http:/polars.rs
import polars as pl
...
try:
    ...
    # Pandas  0:00:29.13
    #  '../dados/202601_NovoBolsaFamilia.csv'
